...
class DQNAgent(Agent):
    ...
    def save(self, model_root_folder_path):
        """
        Saves the agent.
        """
        self.q_eval.save_checkpoint(os.path.join(model_root_folder_path, 'q_eval.chkpt'))
        self.q_next.save_checkpoint(os.path.join(model_root_folder_path, 'q_next.chkpt'))
    ...
    def load(self, model_root_folder_path :str):
        ...
        try:
            ...
            print("It was not possible to load the RL agent.")
